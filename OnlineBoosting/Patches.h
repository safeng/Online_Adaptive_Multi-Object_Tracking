...
public:
	...
	virtual int getStepRow(void) {return stepRow;}
	virtual int getStepCol(void){return stepCol;}
...
private:
	...
	Rect m_rectUpperMiddle;
	Rect m_rectLowerMiddle;
	Rect m_rectMiddleLeft;
	Rect m_rectMiddleRight;
