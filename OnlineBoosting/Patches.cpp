...
Rect PatchesRegularScan::getSpecialRect(const char* what)
{
	...
	if (strcmp(what, "UpperMiddle")==0) return m_rectUpperMiddle;
	if (strcmp(what, "LowerMiddle")==0) return m_rectLowerMiddle;
	if (strcmp(what, "MiddleLeft")==0) return m_rectMiddleLeft;
	if (strcmp(what, "MiddleRight")==0) return m_rectMiddleRight;
